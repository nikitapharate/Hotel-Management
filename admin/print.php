...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>Atharva> HOTEL,</p>
				<p>Karve Road,<br>Pune,<br>Maharashtra.</p>
				<p>(+94) 65 222 44 55</p>
			</address>
			<!-- <h1>Atharva</h1> -->
		</header>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@Atharva.com || Web :- www.Atharva.com || Phone :- +91 65 222 44 55 </p>
			</div>
		</aside>
		

			          <h1><spam>Online Payment Accepted here :- All UPI Phn No:- 9999999999</spam></h1>
